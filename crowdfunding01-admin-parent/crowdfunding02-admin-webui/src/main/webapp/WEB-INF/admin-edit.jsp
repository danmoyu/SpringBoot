                ...
                <div class="panel-body">
                    ...
                    <form action="admin/update.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                    name="loginAcct" value="${requestScope.loginAdmin.loginAcct}"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                    name="userName" value="${requestScope.loginAdmin.userName}"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                    name="email" value="${requestScope.loginAdmin.email}"
